...
internal class SkattekortPersonApiTest :
    FunSpec({
        ...
        test("hent skattekort med frikort for gjeldende år minus 1") {
            ...
            every { skattekortPersonService.hentSkattekortPerson(any(), any()) } returns
                listOf(
            ...
            response
                ...
                .getList<String>("navn")
                .first()
                .shouldBe("Test Testesen")
            response
                .jsonPath()
                .getList<String>("arbeidsgiver[0].arbeidstaker[0].skattekort.forskuddstrekk[0].type")
                .first()
                .shouldBe("Frikort")
        }
        ...
        test("hent skattekort med status resultatPaaForespoersel 'ikkeSkattekort'") {
            ...
            response
                .jsonPath()
                .getList<String>("arbeidsgiver[0].arbeidstaker[0].resultatPaaForespoersel")
                .first()
        ...
        test("hent skattekort med ugyldig inntektsaar") {
            RestAssured
                ...
                .body(
                    "message",
                    equalTo(
                        "Inntektsåret er ugyldig. Inntektsår må være mellom ${Year.now().minusYears(1)} til ${Year.now().plusYears(1)}",
                    ),
                )
        }
